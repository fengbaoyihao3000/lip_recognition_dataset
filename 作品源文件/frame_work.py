...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        """
        self.title1_edit = DropLineEdit(self)
        self.title1_edit.move(300,250)
        self.title1_edit.resize(200,21)
        """
        self.lineEdit_2 = DropLineEdit(self)
        self.lineEdit_2.move(630, 380)
        self.lineEdit_2.resize(200, 21)
        self.text = QTextEdit(self)
        self.text.move(300, 360)
        self.text.resize(230, 150)
    ...
    def setupUi(self, MainWindow):
        ...
        self.warn_n.setGeometry(QtCore.QRect(100, 540, 800, 80))
        self.warn_n.setObjectName("label")
        self.warn_n.setStyleSheet(
            '''QLabel{color:rgb(255,0,0,255);font-size:40px;font-weight:bold;font-family:Roman times;}''')
        ...
        self.browse_1.setGeometry(QtCore.QRect(710, 310, 100, 28))
        ...
        # self.login.clicked.connect(self.)                #点击Login登录
        ...
        self.btn.setGeometry(370, 330, 80, 25)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "唇 部 语 料 库"))
        ...
        self.label_4.setText(_translate("MainWindow", "本软件未购买科大讯飞商业服务，使用时长有限，请谨慎使用，或使用用户自己个人账户\n默认为作者本人账户（无需输入）"))
